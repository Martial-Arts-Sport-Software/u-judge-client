...
object Localization {
    private val strings = mapOf(
        "en" to mapOf(
            ...
            "connection_reconnecting" to "Connection lost. Reconnecting to the server.",
            ...
            "discipline_freestyle_sword" to "Sword freestyle",
            "discipline_freestyle_pole" to "Pole freestyle",
            "discipline_freestyle_nunchaku" to "Paired nunchaku",
            "discipline_freestyle_fans" to "Paired fans",
        ...
        "ru" to mapOf(
            ...
            "combat_event_accepted" to "Сервер подтвердил событие.",
            "combat_event_rejected" to "Сервер отклонил событие.",
            "connection_reconnecting" to "Соединение потеряно. Повторно подключаемся к серверу.",
            ...
            "discipline_freestyle_sword" to "Комплекс с мечом",
            "discipline_freestyle_pole" to "Комплекс с шестом",
            "discipline_freestyle_nunchaku" to "Комплекс с парными нунчаками",
            "discipline_freestyle_fans" to "Комплекс с парными веерами",
