...
U'Judge Client - мобильный судейский пульт U'Judge System для Android и iPhone. Приложение предоставляет боковому судье специализированный интерфейс для восьми дисциплин хапкидо и работает в двух режимах:
