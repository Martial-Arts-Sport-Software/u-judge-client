...
| CLI-036 | Must      | Partial | Shared command transport applies terminal ACK/rejection to outbox; Kerugi renders localized pending/accepted/rejected feedback only for its latest matching event; server integration evidence pending | Состояние каждого недавнего события понятно судье                      |
