...
| CLI-014 | Must      | Partial | Shared HTTP client декодирует metadata и передаёт её validator; discovery/TLS integration pending | Несовместимый server отклоняется с локализованной причиной                            |
