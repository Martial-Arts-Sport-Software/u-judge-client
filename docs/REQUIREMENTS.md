...
| ID      | Приоритет | Статус  | Требование                                                     | Критерий приёмки                                                            |
|---------|-----------|---------|----------------------------------------------------------------|-----------------------------------------------------------------------------|
| CLI-020 | Must      | Partial | Клиент показывает восемь дисциплин                             | Kerugi, Tanbon, Hosinsool, Pair, Group, Sword, Pole, Paired Nunchaku и Paired Fans доступны по правилам режима |
